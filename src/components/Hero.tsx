  ...
  return (
    <section className="min-h-[80vh] flex flex-col justify-center items-center py-20 px-4 animate-fade-in">
      <div className="max-w-4xl space-y-6">
        <h1 className="text-4xl md:text-5xl font-bold text-accent text-center mb-4">
          Mikhail Zholobov
        </h1>
        <h2 className="text-xl md:text-2xl text-primary text-center mb-6">
        ...
        <div className="space-y-4 text-left">
          <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            for companies ranging from startups to large enterprises.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed">
            As I transition into SRE management, I aim to empower teams by delivering scalable infrastructure, 
            enhancing observability, strengthening security, optimizing CI/CD pipelines, and ensuring robust 
